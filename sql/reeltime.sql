...
CREATE TABLE theaters (
    ...
    request_cleaning BOOLEAN NOT NULL, 
...
INSERT INTO theaters (theater_name, cinema_id, capacity, cleaned, request_cleaning, 3D_Flag) VALUES
('Theater 1', 1, 200, TRUE, FALSE, FALSE),
('Theater 2', 1, 300, TRUE, FALSE, TRUE),
('Theater 3', 1, 150, TRUE, FALSE, FALSE),
('Theater 4', 1, 250, TRUE, FALSE, TRUE),
('Theater 1', 2, 200, TRUE, FALSE, FALSE),
('Theater 2', 2, 300, TRUE, FALSE, TRUE),
('Theater 3', 2, 150, TRUE, FALSE, FALSE),
('Theater 4', 2, 250, TRUE, FALSE, TRUE);
...
INSERT INTO seats (seat_row, seat_column, seat_number, seat_available, cleaned, request_cleaning, theater_id) VALUES
('A', 1, 'A1', TRUE, TRUE, FALSE, 1),
('A', 2, 'A2', FALSE, TRUE, FALSE, 1),
('A', 3, 'A3', TRUE, TRUE, FALSE, 1),
('A', 4, 'A4', TRUE, FALSE, FALSE, 1),
('A', 5, 'A5', TRUE, TRUE, FALSE, 1),
('B', 1, 'B1', TRUE, TRUE, FALSE, 1),
('B', 2, 'B2', FALSE, TRUE, FALSE, 1),
('B', 3, 'B3', TRUE, TRUE, FALSE, 1),
('B', 4, 'B4', TRUE, FALSE, FALSE, 1),
('B', 5, 'B5', TRUE, TRUE, FALSE, 1),
('C', 1, 'C1', TRUE, TRUE, FALSE, 1),
('C', 2, 'C2', FALSE, TRUE,FALSE, 1),
('C', 3, 'C3', TRUE, TRUE, FALSE, 1),
('C', 4, 'C4', TRUE, FALSE,FALSE, 1),
('C', 5, 'C5', TRUE, TRUE, FALSE, 1),
('D', 1, 'D1', TRUE, TRUE, FALSE,  1),
('D', 2, 'D2', FALSE, TRUE, FALSE, 1),
('D', 3, 'D3', TRUE, TRUE, FALSE, 1),
('D', 4, 'D4', TRUE, FALSE, FALSE, 1),
('D', 5, 'D5', TRUE, TRUE, FALSE, 1),
('E', 1, 'E1', TRUE, TRUE, FALSE, 1),
('E', 2, 'E2', FALSE, TRUE, FALSE, 1),
('E', 3, 'E3', TRUE, TRUE, FALSE, 1),
('E', 4, 'E4', TRUE, FALSE, FALSE, 1),
('E', 5, 'E5', TRUE, TRUE, FALSE, 1);

-- Insert data into seats for Theater 2
INSERT INTO seats (seat_row, seat_column, seat_number, seat_available, cleaned, request_cleaning, theater_id) VALUES
('A', 1, 'A1', TRUE, TRUE, FALSE, 2),
('A', 2, 'A2', TRUE, TRUE, FALSE, 2),
('A', 3, 'A3', TRUE, TRUE, FALSE, 2),
('A', 4, 'A4', TRUE, TRUE, FALSE, 2),
('A', 5, 'A5', TRUE, TRUE, FALSE, 2),
('B', 1, 'B1', TRUE, TRUE, FALSE, 2),
('B', 2, 'B2', TRUE, TRUE, FALSE, 2),
('B', 3, 'B3', TRUE, TRUE, FALSE, 2),
('B', 4, 'B4', TRUE, TRUE, FALSE, 2),
('B', 5, 'B5', TRUE, TRUE, FALSE, 2),
('C', 1, 'C1', TRUE, TRUE, FALSE, 2),
('C', 2, 'C2', TRUE, TRUE, FALSE, 2),
('C', 3, 'C3', TRUE, TRUE, FALSE, 2),
('C', 4, 'C4', TRUE, TRUE, FALSE, 2),
('C', 5, 'C5', TRUE, TRUE, FALSE, 2),
('D', 1, 'D1', TRUE, TRUE, FALSE, 2),
('D', 2, 'D2', TRUE, FALSE, FALSE, 2),
('D', 3, 'D3', TRUE, TRUE, FALSE, 2),
('D', 4, 'D4', TRUE, TRUE, FALSE, 2),
('D', 5, 'D5', TRUE, TRUE, FALSE, 2),
('E', 1, 'E1', FALSE, TRUE, FALSE, 2),
('E', 2, 'E2', TRUE, TRUE, FALSE, 2),
('E', 3, 'E3', TRUE, TRUE, FALSE, 2),
('E', 4, 'E4', TRUE, TRUE, FALSE, 2),
('E', 5, 'E5', TRUE, TRUE, FALSE, 2),
('F', 1, 'F1', TRUE, TRUE, FALSE, 2),
('F', 2, 'F2', TRUE, TRUE, FALSE, 2),
('F', 3, 'F3', TRUE, FALSE, FALSE, 2),
('F', 4, 'F4', TRUE, TRUE, FALSE, 2),
('F', 5, 'F5', FALSE, TRUE, FALSE, 2);

-- Insert data into seats for Theater 3
INSERT INTO seats (seat_row, seat_column, seat_number, seat_available, cleaned, request_cleaning, theater_id) VALUES
('A', 1, 'A1', TRUE, TRUE, FALSE, 3),
('A', 2, 'A2', TRUE, TRUE, FALSE, 3),
('A', 3, 'A3', TRUE, FALSE, FALSE, 3),
('A', 4, 'A4', TRUE, TRUE, FALSE, 3),
('A', 5, 'A5', TRUE, TRUE, FALSE, 3),
('B', 1, 'B1', TRUE, TRUE, FALSE, 3),
('B', 2, 'B2', TRUE, TRUE, FALSE, 3),
('B', 3, 'B3', TRUE, TRUE, FALSE, 3),
('B', 4, 'B4', TRUE, TRUE, FALSE, 3),
('B', 5, 'B5', TRUE, TRUE, FALSE, 3),
('C', 1, 'C1', TRUE, FALSE, FALSE, 3),
('C', 2, 'C2', TRUE, TRUE, FALSE, 3),
('C', 3, 'C3', TRUE, TRUE, FALSE, 3),
('C', 4, 'C4', TRUE, TRUE, FALSE, 3),
('C', 5, 'C5', TRUE, TRUE, FALSE, 3),
('D', 1, 'D1', TRUE, TRUE, FALSE, 3),
('D', 2, 'D2', TRUE, TRUE, FALSE, 3),
('D', 3, 'D3', TRUE, TRUE, FALSE, 3),
('D', 4, 'D4', TRUE, TRUE, FALSE, 3),
('D', 5, 'D5', TRUE, TRUE, FALSE, 3),
('E', 1, 'E1', TRUE, TRUE, FALSE, 3),
('E', 2, 'E2', FALSE, TRUE, FALSE, 3),
('E', 3, 'E3', TRUE, TRUE, FALSE, 3),
('E', 4, 'E4', TRUE, TRUE, FALSE, 3),
('E', 5, 'E5', TRUE, TRUE, FALSE, 3),
('F', 1, 'F1', TRUE, TRUE, FALSE, 3),
('F', 2, 'F2', TRUE, TRUE, FALSE, 3),
('F', 3, 'F3', TRUE, TRUE, FALSE, 3),
('F', 4, 'F4', TRUE, TRUE, FALSE, 3),
('F', 5, 'F5', TRUE, TRUE, FALSE, 3);

-- Insert data into seats for Theater 4
INSERT INTO seats (seat_row, seat_column, seat_number, seat_available, cleaned, request_cleaning, theater_id) VALUES
('A', 1, 'A1', TRUE, TRUE, FALSE, 4),
('A', 2, 'A2', TRUE, TRUE, FALSE, 4),
('A', 3, 'A3', TRUE, TRUE, FALSE, 4),
('A', 4, 'A4', TRUE, TRUE, FALSE, 4),
('A', 5, 'A5', TRUE, TRUE, FALSE, 4),
('B', 1, 'B1', TRUE, TRUE, FALSE, 4),
('B', 2, 'B2', TRUE, TRUE, FALSE, 4),
('B', 3, 'B3', TRUE, TRUE, FALSE, 4),
('B', 4, 'B4', TRUE, TRUE, FALSE, 4),
('B', 5, 'B5', TRUE, TRUE, FALSE, 4),
('C', 1, 'C1', TRUE, TRUE, FALSE, 4),
('C', 2, 'C2', TRUE, TRUE, FALSE, 4),
('C', 3, 'C3', FALSE, TRUE, FALSE, 4),
('C', 4, 'C4', TRUE, TRUE, FALSE, 4),
('C', 5, 'C5', TRUE, TRUE, FALSE, 4),
('D', 1, 'D1', TRUE, TRUE, FALSE, 4),
('D', 2, 'D2', TRUE, TRUE, FALSE, 4),
('D', 3, 'D3', TRUE, TRUE, FALSE, 4),
('D', 4, 'D4', TRUE, TRUE, FALSE, 4),
('D', 5, 'D5', TRUE, TRUE, FALSE, 4),
('E', 1, 'E1', TRUE, FALSE, FALSE, 4),
('E', 2, 'E2', TRUE, TRUE, FALSE,4),
('E', 3, 'E3', TRUE, TRUE, FALSE, 4),
('E', 4, 'E4', TRUE, TRUE, FALSE, 4),
('E', 5, 'E5', TRUE, TRUE, FALSE, 4),
('F', 1, 'F1', TRUE, TRUE, FALSE, 4),
('F', 2, 'F2', TRUE, TRUE, FALSE, 4),
('F', 3, 'F3', FALSE, TRUE, FALSE, 4),
('F', 4, 'F4', TRUE, TRUE, FALSE, 4),
('F', 5, 'F5', TRUE, FALSE, FALSE, 4);
