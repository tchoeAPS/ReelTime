...
('Theater 3', 1, 150, TRUE, FALSE),
('Theater 4', 1, 250, TRUE, TRUE),
('Theater 1', 2, 200, TRUE, FALSE),
('Theater 2', 2, 300, TRUE, TRUE),
...
(1, 4, 'Nice theater with great customer service.', 'Yelp'),
(2, 5, 'The theater rooms are always very clean and the chairs are confortable.', 'Google Reviews'),
(2, 4, 'The staff at this location are super friendly!', 'Yelp'),
(1, 5, 'I see all of my favorite movies here.', 'Google Reviews'),
(2, 4, 'Perfect theater to go to with the kids. My kids enjoy the 3-D movies.', 'Yelp'),
(2, 5, 'We booked a birthday party and had a blast!', 'Google Reviews'),
(1, 4, 'The manager John is a great guy. He was very accommodating to my handicapped mother.', 'Yelp');
...
('Nico Williams', 'nicowilliams', 'nico123', 'nicowilliams@reeltime.com', TRUE, 'General Manager', 2);
